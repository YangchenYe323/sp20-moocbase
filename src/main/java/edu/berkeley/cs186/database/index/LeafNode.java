...
class LeafNode extends BPlusNode {
    ...
    public LeafNode getLeftmostLeaf() {
        ...
        //on the leftmost leaf node
        //all the check is don by inner node
        return this;
    }
    ...
    public Optional<Pair<DataBox, Long>> bulkLoad(Iterator<Pair<DataBox, RecordId>> data,
        ...
        while (data.hasNext()) {
            ...
            //just add the data, no need to check
            //assumption: the given data is ordered
    ...
    public static LeafNode fromBytes(BPlusTreeMetadata metadata, BufferManager bufferManager,
        ...
        long rightSibPageNum = buf.getLong();
        int size = buf.getInt();
        ...
        return new LeafNode(metadata, bufferManager, page, keys, rids, Optional.of(rightSibPageNum), treeContext);
    }
